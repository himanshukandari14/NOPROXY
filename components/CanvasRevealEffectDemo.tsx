...
export function CanvasRevealEffectDemo() {
  return (
    <>
    <div className="text-8xl font-semibold bg-black flex justify-center items-center mt-4">Key Features</div>
      <div className="py-20 flex flex-col lg:flex-row items-center justify-center bg-black dark:bg-black w-full gap-4 mx-auto px-8">
        ...
        <div></div>
        <Card title="Face Detection" icon={<AceternityIcon />}>
          <CanvasRevealEffect
            animationSpeed={5.1}
            containerClassName="bg-emerald-900"
          />
        </Card>
        <Card title="Analyze" icon={<AceternityIcon />}>
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card title="Save it into Excel sheet" icon={<AceternityIcon />}>
          <CanvasRevealEffect
            animationSpeed={3}
